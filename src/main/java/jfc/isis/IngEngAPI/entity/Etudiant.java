...
public class Etudiant {
    ...
    public boolean equals(Object o) {
        ...
        if (id != null ? !id.equals(etudiant.id) : etudiant.id != null) return false;
        ...
        if (identifiant != null ? !identifiant.equals(etudiant.identifiant) : etudiant.identifiant != null)
            return false;
        if (mdp != null ? !mdp.equals(etudiant.mdp) : etudiant.mdp != null) return false;
